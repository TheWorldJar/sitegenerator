...
class TestBlockToBlockType(unittest.TestCase):
    ...
    def test_quote(self):
        ...
        self.assertEqual(block_to_block_type("> Quote with **bold** and _italic_"), BlockType.QUOTE)
        self.assertEqual(block_to_block_type(">Single line quote"), BlockType.QUOTE)
        self.assertEqual(block_to_block_type(">First line\n>Second line"), BlockType.QUOTE)
        self.assertEqual(block_to_block_type(">Quote with **bold** and _italic_"), BlockType.QUOTE)
    ...
    def test_unordered_list(self):
        ...
        self.assertEqual(block_to_block_type("- Item with **bold** and _italic_"), BlockType.ULIST)
    ...
    def test_ordered_list(self):
        ...
        self.assertEqual(block_to_block_type("1. Item with **bold** and _italic_"), BlockType.OLIST)

    def test_paragraph(self):
        # Test paragraph blocks
        self.assertEqual(block_to_block_type("Regular paragraph text"), BlockType.PARA)
        self.assertEqual(block_to_block_type("Paragraph with **bold** and _italic_"), BlockType.PARA)
    ...
    def test_edge_cases(self):
        ...
        self.assertEqual(block_to_block_type("#Heading without space"), BlockType.PARA)  # Invalid heading
        self.assertEqual(block_to_block_type("-Item without space"), BlockType.PARA)  # Invalid unordered list
        self.assertEqual(block_to_block_type("1.Item without space"), BlockType.PARA)  # Invalid ordered list

    def test_mixed_content(self):
        # Test mixed content that should be treated as paragraphs
        self.assertEqual(block_to_block_type("> First line\nSecond line"), BlockType.PARA)  # Mixed quote and regular text
        self.assertEqual(block_to_block_type("> First line\n- Second line"), BlockType.PARA)  # Mixed quote and list
        self.assertEqual(block_to_block_type("- First item\nSecond line"), BlockType.PARA)  # Mixed list and regular text
        self.assertEqual(block_to_block_type("1. First item\n- Second item"), BlockType.PARA)  # Mixed ordered and unordered list
        self.assertEqual(block_to_block_type("1. First item\n> Second line"), BlockType.PARA)  # Mixed list and quote
        self.assertEqual(block_to_block_type("> First line\n1. Second line"), BlockType.PARA)  # Mixed quote and list
        self.assertEqual(block_to_block_type("> First line\n- Second line\nThird line"), BlockType.PARA)  # Mixed quote, list, and regular text
        self.assertEqual(block_to_block_type("1. First item\n2. Second item\nThird line"), BlockType.PARA)  # Mixed ordered list and regular text
        self.assertEqual(block_to_block_type("- First item\n- Second item\nThird line"), BlockType.PARA)  # Mixed unordered list and regular text
