...
class TestLeafNode(unittest.TestCase):
    ...
    def test_to_html4(self):
        ...
        self.assertEqual(
            node.to_html(),
            '<div href="https://www.google.com" target="_blank">Hello, world!</div>',
        )
...
class TestParentNode(unittest.TestCase):
    ...
    def test_to_html_with_children_and_props(self):
        ...
        self.assertEqual(
            node.to_html(),
            '<div><div href="https://www.google.com" target="_blank">Hello, world!</div></div>',
        )
    ...
    def test_to_html_with_multiple_children_and_props(self):
        ...
        self.assertEqual(
            node.to_html(),
            '<div><div href="https://www.google.com" target="_blank">Hello, world!</div><div>Hello, world!</div></div>',
        )

    def test_to_html_with_grandchildren(self):
        node = ParentNode(
            "div", [ParentNode("div", [LeafNode("div", "Hello, world!", {})], {})], {}
        )
        self.assertEqual(
            node.to_html(), "<div><div><div>Hello, world!</div></div></div>"
        )
    ...
    def test_to_html_with_grandchildren_and_props(self):
        ...
        self.assertEqual(
            node.to_html(),
            '<div><div><div href="https://www.google.com" target="_blank">Hello, world!</div></div></div>',
        )
    ...
    def test_to_html_with_multiple_grandchildren(self):
        ...
        self.assertEqual(
            node.to_html(),
            "<div><div><div>Hello, world!</div><div>Hello, world!</div></div><div><div>Hello, world!</div><div>Hello, world!</div></div></div>",
        )
    ...
    def test_to_html_with_multiple_grandchildren_and_props(self):
        ...
        self.assertEqual(
            node.to_html(),
            '<div><div><div href="https://www.google.com" target="_blank">Hello, world!</div><div>Hello, world!</div></div><div><div>Hello, world!</div><div href="https://www.google.com" target="_blank">Hello, world!</div></div></div>',
        )
